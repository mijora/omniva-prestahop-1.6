...
<div class="tab-content">
        ...
        <h4>{l s='Generated' mod='omnivaltshipping'}</h4>
         ...
         {foreach from=$orders key=myId item=i}
			...
			{/if}
                        <tr>
                            <td>{$i.id_order}</td>
                            <td><a href="{$orderLink}&id_order={$i.id_order}">{$i.firstname} {$i.lastname}</a></td>
                            <td>{$i.tracking_number}</td>
                            <td>{$i.date_upd}</td>
                            <td>{$i.total_paid}</td>
                            <td>
   ...
   <div class="tab-pane" id="tab-search">
      <h4>{l s='Search shipment by customer, tracking nr. and label generation date' mod='omnivaltshipping'}</h4>
   <br>
    <table class="table">
    <thead>
		<tr class="nodrag nodrop">
			...
			<th width='15%'>
				<span class="title_box">{l s='Labels' mod='omnivaltshipping'}</span>
                    ...
                    <script type="text/javascript">
                        ...
                        <tr ><td>{l s='Search' mod='omnivaltshipping'}</td></tr>
                        </tbody>
                        </table>
    </div>
</div>
